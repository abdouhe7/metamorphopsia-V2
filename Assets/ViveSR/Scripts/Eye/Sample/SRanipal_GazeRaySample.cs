        ...
        namespace Eye
        {
            public class SRanipal_GazeRaySample : MonoBehaviour
            {
                ...
                private static void EyeCallback(ref EyeData eye_data)
                {
                    ...
                    d="frame_sequence"+eye_data.frame_sequence.ToString() ;
                    d+= "- convergence_distance_mm" + eye_data.verbose_data.combined.convergence_distance_mm;
                    d+="- convergence_distance_validity" + eye_data.verbose_data.combined.convergence_distance_validity.ToString();
                    d += "- left.gaze_origin_mm" + eye_data.verbose_data.left.gaze_origin_mm.ToString();
                    d+="- right.gaze_origin_mm" + eye_data.verbose_data.right.gaze_origin_mm.ToString();
                   Debug.Log(d);
